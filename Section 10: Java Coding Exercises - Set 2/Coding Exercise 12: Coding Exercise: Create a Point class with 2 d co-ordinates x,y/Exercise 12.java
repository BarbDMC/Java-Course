...
public class Point {
    ...
    public double distanceTo(Point other) {
        // Your code here
        int xPointsSubtraction = this.x - other.x;
        int yPointsSubtraction = other.y - this.y;
        
        int xSubtractionSquare = (int) Math.pow(xPointsSubtraction, 2);
        int ySubtractionSquare = (int) Math.pow(yPointsSubtraction, 2);
        
        int coordinatesSum = xSubtractionSquare + ySubtractionSquare;
        
        double squareRoot = Math.sqrt(coordinatesSum);
